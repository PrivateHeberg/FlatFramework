...
include_once dirname(__FILE__) . "/MySQLManager/Structure.php";
include_once dirname(__FILE__) . "/MySQLManager/Cache.php";
include_once dirname(__FILE__) . "/MySQLManager/Literal.php";
include_once dirname(__FILE__) . "/MySQLManager/Result.php";
include_once dirname(__FILE__) . "/MySQLManager/MultiResult.php";
include_once dirname(__FILE__) . "/MySQLManager/Row.php";
